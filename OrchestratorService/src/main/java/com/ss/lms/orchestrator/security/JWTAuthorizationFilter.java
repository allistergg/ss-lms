...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
	...
	private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request) {
		...
		if (token != null) {
			...
			Claim claim = JWT.decode(token.replace(SecurityConstants.TOKEN_PREFIX, "")).getClaim("authorities");

			List<SimpleGrantedAuthority> authorities = Arrays.stream(claim.asString().split(","))
